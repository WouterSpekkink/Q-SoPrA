...
QString COLLIGATEPATHSACTION = "Colligation based on paths";
QString COLLIGATESEMIPATHSACTION = "Colligate based on semi-paths";
QString MAKEMACROACTION = "Colligate single event";
QString PATHS = "Paths";
