...
QString COLLIGATEACTION = "Create abstract event";
...
QString TRANSFORMED = "Tranfsormed";
...
QString LINE = "Line";
QString SINGLEARROW = "Single arrow";
QString DOUBLEARROW = "Double arrow";
QString ELLIPSE = "Ellipse";
QString RECT = "Rectangle";
QString TEXT = "Text Object";
...
QString CHANGEELLIPSEFILLCOLOR = "Change ellipse fill color";;
QString DELETEELLIPSE = "Delete ellipse";
QString CHANGERECTCOLOR = "Change rectangle color";
QString CHANGERECTFILLCOLOR = "Change rectangle fill color";
QString DELETERECT = "Delete rectangle";
QString CHANGETIMELINECOLOR = "Change timeline color";
